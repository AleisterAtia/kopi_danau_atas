...
<div class="ab">
    ...
    <section class="ab-head">
        <div class="ab-wrap">
            ...
            <h1>{{ $about->title ?? __('Tentang CV Kopi Danau Atas') }}</h1>
            <p>{{ __('CV Kopi Danau Atas memadukan kebun Arabika dataran tinggi Solok dengan wisata edukasi — dari kebun hingga cangkir.') }}</p>
        </div>
    </section>
    ...
    <section class="ab-nilai">
        <div class="ab-wrap">
            ...
            <div class="ab-nilai__grid">
                @php
                    $values = [
                        ['M3 20h18L14 4l-4 8-3-3-4 11z', __('Kualitas dari Ketinggian'), __('Arabika 1.400 mdpl, dipetik matang dan diolah dengan cermat.')],
                        ['M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.247m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.247', __('Edukasi Terbuka'), __('Kami berbagi setiap tahap proses kopi kepada pengunjung.')],
                        ['M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z', __('Kemitraan Petani'), __('Tumbuh bersama masyarakat kebun, bukan di atas mereka.')],
                        ['M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064', __('Keberlanjutan'), __('Menjaga lanskap Danau Diatas untuk generasi berikutnya.')],
                    ];
                @endphp
                @foreach($values as $v)
                    <div class="ab-nilai__c" data-reveal>
                        <div class="ab-nilai__ic"><svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.7" d="{{ $v[0] }}"/></svg></div>
                        <h3>{{ $v[1] }}</h3>
                        <p>{{ $v[2] }}</p>
                    </div>
                @endforeach
                ...
                <div class="ab-map" data-reveal>
                    ...
                    @else
                        <div class="ab-map__fb">
                            ...
                            {{ __('Alahan Panjang, Solok — Sumatera Barat') }}
                        </div>
                    @endif
                </div>
            </div>
